...
/** El candado macizo de la ficha nativa. El `Lock` de arriba es de trazo y vive
 *  en el muro, donde va grande; a 15 px el trazo se deshace y se lee como una
 *  mancha, así que la lista de capítulos usa este. */
export const Candado = ({ s = 15 }: { s?: number }) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="M8.6 10V7.5a3.4 3.4 0 0 1 6.8 0V10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    <rect x="4.8" y="9.8" width="14.4" height="11.2" rx="2.6" fill="currentColor" />
  </svg>
)

export const Chevron = ({ s = 22 }: { s?: number }) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="m9.5 5.5 7 6.5-7 6.5" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)

export const Check = ({ s = 15 }: { s?: number }) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="m5 12.5 4.6 4.5L19 7" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
