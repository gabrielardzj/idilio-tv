...
> **La pregunta.** El **95%+ de la base de Idilio no paga** [M, brief]. ¿Cómo se monetiza a esa
> mayoría sin romper lo que ya factura — y qué dice el mercado sobre por qué alguien paga por video
> cuando tiene entretenimiento infinito y gratis a un pulgar de distancia?
>
> **Qué es esto.** No es un entregable del reto: los cuatro que pidió el brief están
> [en el sitio](../01-diagnostico/) y hablan de retención. Esto sale de aplicarle al mismo material
> una pregunta distinta — **cómo gana plata Idilio**.
>
> **Procedencia.** **[M]** medido —por el censo, el brief o un tercero citado—, **[S]** supuesto
> declarado con banda, **[I]** inferencia. **Ningún número de ingreso publicitario de esta página
> es un dato de Idilio.** Lo que aporto es la estructura de la cuenta; los seis datos que la
> cierran están en [§6.7](#67-los-seis-datos-que-faltan).
...
> **En el mundo esta categoría cobra** —el 60% de su ingreso es pago directo, y saca US$ 10–25 por
> usuario al mes contra los US$ 3–8 del streaming—; **en Latinoamérica el dinero se está moviendo
> a la publicidad** —AVOD +74%, y en Brasil ya es el 37% del ingreso de streaming—. **Idilio está
> en ese cruce, y por eso necesita las dos líneas.**

Y el orden de prioridad que se sigue de ahí: **si una decisión obliga a elegir entre proteger la
conversión y subir la impresión, gana la conversión.**

---

## 6.2 La investigación, en tres bloques

*Secundaria, septiembre de 2026, sobre fuentes públicas enlazadas. Son datos de terceros con
calidad desigual: las casas de análisis —Ampere, Omdia, Sensor Tower, Deloitte, 3Vision— pesan más
que los agregadores de estadísticas.*

### Bloque 1 · Esta audiencia ya está viendo microdrama, y gratis

| Dato | Fuente |
|---|---|
| **El 44% de quienes ven microdrama lo hacen en YouTube y el 38% en TikTok** · más de 1 de cada 10 usuarios de internet ya vio el formato | [Ampere](https://worldscreen.com/tvdrama/ampere-micro-dramas-draw-massive-global-viewer-numbers/), encuesta a 100.000 consumidores |
| **Latinoamérica es el 23% de las descargas globales** de apps de microdrama · 850 M en el trimestre, +140% interanual | [Sensor Tower](https://sensortower.com/blog/state-of-short-drama-apps-2026-report) |
| Tiempo diario en la categoría: **25 minutos y subiendo**, mientras el streaming tradicional lleva años plano en ~35 | ídem |

> **Conclusión: el competidor de Idilio no es ReelShort. Es el feed** — y el feed no cobra.

### Bloque 2 · Y aun así, esta categoría cobra

| Dato | Fuente |
|---|---|
| **El 60% del ingreso mundial del microdrama viene de suscripción o pago transaccional**, no de publicidad · mercado global ≈ US$ 11 B | Omdia, vía [Digital Content Next](https://digitalcontentnext.org/blog/2026/03/05/how-microdramas-hook-viewers-and-drive-revenue/) |
| El microdrama saca **US$ 10–25 por usuario al mes**; el streaming tradicional, **US$ 3–8** — *«la monetización ocurre dentro del bucle emocional, no contra un muro de suscripción»* | [Streaming Radar](https://lens.streaming-radar.com/micro-drama-apps) |
| Ingreso in-app de micro-series: **US$ 3,8 B en 2025 → US$ 7,8 B proyectados para 2026** | [Deloitte](https://www.deloitte.com/us/en/insights/industry/technology/technology-media-and-telecom-predictions/2026/short-form-video-series.html) |
| **ByteDance —dueña de TikTok— vende microdrama en dos apps de pago aparte:** PineDrama (ene-2026, EE.UU. y Brasil, *sin anuncios*) y LimeShorts (**US$ 20/semana**) | [Tubefilter](https://www.tubefilter.com/2026/07/23/tiktok-lime-shorts-paid-microdrama-app/) |

> **Conclusión: lo que se paga no es el video, es el final.** Y la prueba más dura es la última
> fila: **la empresa que mejor conoce la economía de la atención gratuita decidió que el microdrama
> no se monetiza dentro de TikTok, sino en una app aparte y de pago.** Si el feed pudiera capturar
> este valor, ByteDance no estaría construyendo dos aplicaciones para hacerlo.

**El mecanismo, en una tabla:**

| | **El feed** (TikTok, Reels, Shorts) | **La serie** (Idilio, ReelShort, Netflix) |
|---|---|---|
| Qué vende | Una sesión | Un final |
| Costo de abandonar | **Cero.** Siempre hay otro video, siempre gratis | **No saber cómo termina** |
...
### Bloque 3 · Y en esta región el dinero se está moviendo a la publicidad

| Dato | Fuente |
|---|---|
| **El AVOD latinoamericano crece 74% hasta US$ 8,0 B** · el FAST duplica de US$ 1,0 B a 2,1 B | [3Vision](https://www.3vision.tv/news-insights/americas-streaming-market-forecast-2026-2031-a-165-billion-market-running-at-two-speeds) |
| **En Brasil —el mercado más maduro de la región— la publicidad ya es el 37% del ingreso de streaming** · Globoplay factura US$ 640 M solo en AVOD | ídem |
| Las suscripciones SVOD suben **25%** y el ingreso solo **14%**: cada suscriptor nuevo vale menos que el anterior · ARPU de Netflix en LatAm ≈ **US$ 7** contra US$ 18,65 en EE.UU./Canadá | ídem |
| **Tubi, Pluto TV y The Roku Channel sacan la mejor calificación de «valor excelente»** de toda la categoría — por delante de Prime, Max, Apple TV y Netflix | [Advanced Television](https://www.advanced-television.com/2026/07/13/research-us-streaming-consumers-prioritise-low-price/) |
...
COP** al peldaño regular [M].

> **Para que un anuncio pagara el episodio que abre, el eCPM tendría que ser de ≈ US$ 177.**
> *($ 540 COP por impresión × 1.000, a la tasa de ≈ 3.050 COP/USD que usa
> [§3.4bis](../03-diseno/#34bis--el-precedente-revisado-en-contra).)*
>
> **El eCPM real de video recompensado en Colombia está entre US$ 2 y 6 [S]. La brecha es de 30 a
> 90 veces.**

**Eso no es una pérdida de $ 540 por anuncio**: el valor regalado solo es real contra el
contrafáctico de que esa persona hubiera pagado, y para quien no paga nunca el intercambio no
cuesta nada. **La conclusión correcta no es que el grifo sea caro: es que no es un canal de
ingreso.**
...
mínima. Esa es toda la propuesta A en una frase.

> **Y refuerza [I2](../02-estrategia/#i2--el-muro-muestra-las-salidas-que-ya-existen)**, que ya era
> lo más barato del portafolio: subir el anuncio recompensado al primer renglón del muro y traducir
> su `0/10` a *«te quedan 10 episodios gratis hoy»*. Ahora tiene una segunda razón — **cada
...
### Cuatro productos publicitarios, no uno
...
**P4 es el único renglón que no depende de escala**, y por eso el que conviene probar primero: una
marca, una serie, y se sabe si el mercado existe. *No le pongo precio porque no hay comparables en
el mercado hispano y no voy a inventarlo.*

**Lo que hay que construir:** mediación con pisos por formato y geografía · **clasificación de
contenido por serie**, que es lo que permite acceder a demanda de marca y hoy no existe ·
plataforma de consentimiento para la UE y cumplimiento de Ley 1581 en Colombia · pisos de precio
calculados como **el 60% del eCPM mediano de las 4 semanas previas**, revisados cada mes.

**Y una ventaja que Idilio ya tiene y no cobra:** es video vertical de pantalla completa, el formato
para el que los anunciantes **ya producen** porque es el de TikTok, Reels y Shorts. No hay que
pedirle a nadie una creatividad especial — la fricción que mata a la mayoría de los inventarios
nuevos.

### La restricción que impone un episodio de 90 segundos

**Un anuncio de 30 segundos sobre un episodio de 90 es un impuesto del 33%**, y la queja ya está
...
5. **El corte se anuncia** con cuenta regresiva. Lo que destruye la sesión no es el anuncio: es no saber cuánto falta.
6. **Nunca sobre el final de una serie ni sobre el episodio que abre un Pase de la Noche.**
...
Si lo que se paga es saber cómo termina, entonces **la tienda de Idilio está vendiendo la unidad
equivocada.** Hoy vende monedas y episodios sueltos; lo que el espectador quiere comprar es el
final.

### B1 · El escalón alto se vende como *«termina esta historia»*

El paquete ya existe —*«Completa la serie»*, 725 monedas— y está roto: cuesta casi el doble que el
anterior y mejora el precio por episodio un **1,7%**
[M, [F3](../01-diagnostico/#f3--comprar-el-paquete-más-grande-no-le-conviene-a-nadie)].

**La escalera no necesita un escalón nuevo: necesita que el de arriba deje de venderse como un
bulto de monedas.** Con el nombre de la serie adentro, el total dicho de una vez, y un precio que
mejore de verdad al subir.

> **Regla de precio:** completar cualquier serie con monedas cuesta **como máximo el 60% del plan
> mensual.** Hoy terminar la serie mediana sale ≈ $ 21.000 y el mensual abre el catálogo entero por
> $ 24.500 [M, [§5.1](../05-benchmark/)]: **una serie no puede costar lo mismo que todas.**

### B2 · La suscripción se vende como *«sin cortes»*, y en compromisos cortos
...
molestia que no tiene. **Con los cortes de la propuesta A el beneficio se vuelve real** — y es
...
reseñas de una estrella. **En un catálogo que se agota, el compromiso corto no es una debilidad del
producto: es su forma correcta** — y explica el 29% del ingreso de suscripción regional que se
lleva el plan semanal [M, RevenueCat]. Semanal y mensual se quedan.

### B3 · El muro dice qué se está comprando

La disposición a pagar aparece en el cliffhanger y solo ahí. El muro es esa pantalla, y hoy habla
de saldos:
...
[D2](../03-diseno/#d2--lo-gratis-siempre-va-arriba-de-lo-pago); las dos primeras líneas vienen de
la [intervención entregada](../03-diseno/) y la tercera, de la propuesta A.*

### Por qué B vale más por usuario que A

El microdrama saca **US$ 10–25 por usuario al mes** y el 60% del ingreso de la categoría es pago
directo. **A US$ 10 al mes, un solo punto porcentual de conversión rinde US$ 0,10 por MAU — lo
mismo que toda la línea publicitaria del escenario base.**

Eso no vuelve prescindible la propuesta A, porque el 95% no paga y sobre esa mayoría la publicidad
es el único instrumento que existe. Lo que fija es **el orden: primero no romper la conversión,
después subir la impresión.**

*Salvedad: esos US$ 10–25 son de mercados desarrollados. En Latinoamérica —ARPU de Netflix US$ 7
contra US$ 18,65 en EE.UU.— la cifra real será bastante menor, y la brecha con la publicidad se
achica.*

---

## 6.6 Cómo se mide, y cuándo se revierte

Las tres señales de la [estrategia](../02-estrategia/#23-el-portafolio): *leading* —¿pasó algo?—,
*lagging* —¿valió la pena?— y *guardrail* —¿hay que parar?—. El número del guardrail **es el
criterio de reversión**, decidido de antemano.
...
desde el primer día**. Es la única forma de distinguir «los anuncios molestan» de «esta semana hubo
menos contenido nuevo».

---

## 6.7 Los seis datos que faltan
...
## 6.8 Lo que NO propone

| Descartado | Por qué |
|---|---|
| **Ampliar el catálogo a géneros nuevos** | Queda **fuera del alcance** de esta propuesta. Es una decisión de contenido con su propio costo y su propio riesgo de marca, y ninguna de las dos propuestas de acá la necesita para funcionar |
...
> **En una frase.** Idilio ya monetiza con anuncios, pero los usa como cupón de descuento en vez de
> como línea de ingreso; y ya tiene una tienda, pero vende monedas cuando lo que el espectador
> quiere comprar es el final. **Cobrar la atención del que no paga, y venderle la resolución al que
> sí.**
