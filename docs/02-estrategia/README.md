...
Y una corrección al muro donde ocurren los tres: **tiene tres salidas, no dos**. Idilio ya vende un pase semanal a $7.99 y uno mensual a $14.99 —la ficha de App Store del build 1.20.0 los lista, [benchmark §5.1](../05-benchmark/#51--qué-es-idilio-tv-con-los-datos-que-el-brief-no-traía)— y el muro no ofrece ninguno de los dos. El producto de mayor valor de la economía no aparece en el momento de máxima intención. El muro rediseñado muestra las tres: el pase de la noche, el pack de monedas y la suscripción. Ofrecerla ahí no es proponer la suscripción como mecánica de retención —eso sigue descartado en [§2.6](#26-qué-queda-deliberadamente-afuera)—: es dejar de esconder lo que el producto ya vende.
...
3. **Push es —estimo— el 40% del valor del pase, y hoy no está disponible para el 88%.** El 40% es mi estimación, no un dato medido: no tengo con qué sostenerlo más que el argumento. Un pase con countdown sin notificación que avise que ya está listo pierde buena parte de su efecto. Sin cuenta no hay push confiable. **Mitigación:** en Ola 2 se usa push anónimo por token de dispositivo (iOS y Android lo permiten sin cuenta), y se acepta que el valor completo llega recién con I7.
...
| Anuncios recompensados como fuente | Es la fuente obvia y ya es estándar de la categoría: DramaBox permite hasta 15 anuncios diarios, unos 6 episodios gratis por día, y ReelShort también los ofrece. La cifra de DramaBox es de fuente secundaria —una guía de terceros, no la app— y queda por verificar; la uso porque es la mejor que encontré. Pero cambia la naturaleza del producto (de corto-premium a ad-supported) y ese es un llamado de negocio, no de diseño. Lo señalo, no lo decido. |
