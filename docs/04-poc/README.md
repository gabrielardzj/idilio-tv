...
**El entregable no se podía recorrer entero.** El brief pide los cuatro entregables **en un solo link**, y ese link abría el prototipo — que no enlazaba a ningún lado. El diagnóstico (35% de la evaluación), la estrategia y el archivo de diseño estaban publicados y eran **inalcanzables desde la puerta de entrada**: había que conocer la URL exacta. En el teléfono era peor todavía, porque el panel lateral no se muestra y la cuenta de enlaces alcanzables era **cero**.

Lo encontré rastreando el sitio publicado con un crawler: visitó una sola página, porque no había ninguna otra a la que ir. Las páginas de documentos **sí** estaban bien enlazadas entre sí y de vuelta al prototipo y a los flujos; el agujero era de una sola dirección, y justo en la dirección por la que entra el evaluador.

Ahora la puerta de entrada abre con los siete destinos —los cuatro entregables numerados con su peso, el archivo de diseño, los flujos y la versión sobre el stack real— y en móvil ese bloque aparece debajo del teléfono, que es lo único del panel que ahí tiene sentido.

*Y ahora lo verifica CI.* [`verificar-enlaces.mjs`](../../poc/scripts/verificar-enlaces.mjs) recorre el sitio ya armado, comprueba que **todo href interno de todo HTML resuelva a un archivo** y que la puerta de entrada ofrezca los siete destinos —los busca en el bundle, porque el prototipo los pinta con React y no están en el HTML—. Quitando uno, falla nombrándolo; borrando una página, lista las cuatro que la enlazaban.
