...
**`/mobbin-export`** · 11 pantallas en 6 flujos, capturadas automáticamente del POC.

---

## 4.1 Qué está construido

El alcance que pide el brief es *"la pantalla o el momento donde ocurre la mecánica"*. El momento es **el muro de desbloqueo**, y está resuelto con sus once estados:
...
| 10 | Guardar la racha | El prompt de cuenta con las tres cifras en juego |
| 11 | Mi economía | Fuentes, sumidero y posición, en una sola vista |
...
## 4.4 Dos cosas que cambiaron por usar el prototipo
