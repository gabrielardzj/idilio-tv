...
| Fuentes gratuitas | 10 **anuncios** al día × 15 monedas · racha diaria 15·40·60·50·40·45·200 · tareas 90 | Recompensas y modal de racha |
| Pase Idilio | $ 12.500 semanal · $ 24.500 mensual | Pestaña Recompensas, app nativa |

**Y las cifras se verifican solas.** `npm run verificar` corre 59 comprobaciones de los
documentos contra el código y contra el censo del catálogo: 49 son cifras —episodios, monedas,
precios en pesos, porcentajes, los topes de las fuentes gratuitas y los conteos que anuncian los
encabezados— y 10 son invariantes que ninguna cifra sola expresa: que cada serie cuadre, que la
...
el tope de anuncios y los episodios que rinden coincidan por aritmética y no por definición, y que
