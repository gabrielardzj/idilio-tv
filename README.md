...
**Fuera del reto ·** [Monetización](docs/06-monetizacion/) — cómo se monetiza al 95% de la base que no paga, sin romper lo que ya factura. La investigación de mercado y dos propuestas: llevar la pauta a las capas gratuitas que el producto ya tiene, y cobrar por la resolución en vez de por el episodio. No lo pidió el brief; nace de una pregunta posterior sobre el mismo material. Es una página del sitio.
