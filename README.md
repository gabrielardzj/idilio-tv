...
| **Export de flujos** — 21 pantallas en 8 flujos | **https://gabrielardzj.github.io/idilio-tv/flujos/** |
...
| **4** | **[POC](docs/04-poc/)** | Prototipo funcional · [`/poc`](poc/) · y el [export de flujos](mobbin-export/) con 21 pantallas en 8 flujos. |
